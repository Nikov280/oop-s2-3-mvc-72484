...
namespace VGCManagement.VMC.Controllers
{
    public class ExamsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CourseId,Title,ResultsReleased,Date")] Exam exam)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CourseId,Title,ResultsReleased,Date")] Exam exam)
        {
            if (id != exam.Id)
            {
                return NotFound();
        ...
        {            
            ...
            if (exam != null)
            {                
                var relatedResults = _context.ExamResults.Where(r => r.ExamId == id);
